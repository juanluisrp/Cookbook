...
task :recipe do
  ...
  open(filename, 'w') do |recipe|
    ...
    recipe.puts 'goal: "Brief description with the goal of this recipe"'
    ...
    recipe.puts ""
    recipe.puts "## Descripcion"
    recipe.puts "A brief description of concepts if required, otherwise remove this section."
    recipe.puts ""
    recipe.puts "## Demo"
    ...
    recipe.puts "Step by step explanation."
    recipe.puts ""
    recipe.puts "..."
  end
